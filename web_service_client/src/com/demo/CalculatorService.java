 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://demo.com/", wsdlLocation = "http://localhost:8080/calculatorapp?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://demo.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/calculatorapp?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://demo.com/", "CalculatorPort"), Calculator.class);
    }
